...
public interface mealDao {
    ...
    @Select("SELECT type,name,good,medim_poor,sum,intro,teste,img FROM meal")
    ...
    @Select("SELECT type,name,good,medim_poor,sum,intro,teste,img FROM meal where type = #{type}")
    ...
    @Insert("insert into meal(type,name,good,medim_poor,sum,intro,teste,img)values (#{type},#{name},#{good},#{medim_poor},#{sum},#{intro},#{teste},#{img})")
